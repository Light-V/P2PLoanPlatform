...
create table `repay_plan` (
	...
	`status` int not null comment '还款状态，0为未还，1为已还, 2为逾期未还，3为担保人垫付，4为逾期已还',
    `overdue_proceeded` int not null comment '是否已经执行逾期处理，1为已经执行',
...
CREATE TABLE `bank_account`  (
  `card_id` varchar(19) NOT NULL COMMENT '银行卡ID',
